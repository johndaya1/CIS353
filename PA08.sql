...
*/
SELECT RANK(30000) WITHIN GROUP(ORDER BY salary ASC) AS rank
FROM employee;
...
*/
SELECT RANK(31000) WITHIN GROUP(ORDER BY salary ASC) AS rank
FROM employee; 
--
...
*/
SELECT DENSE_RANK(30000) WITHIN GROUP(ORDER BY salary ASC) AS rank
FROM employee;
...
*/
SELECT DENSE_RANK(31000) WITHIN GROUP(ORDER BY salary ASC) AS rank
FROM employee;
--
